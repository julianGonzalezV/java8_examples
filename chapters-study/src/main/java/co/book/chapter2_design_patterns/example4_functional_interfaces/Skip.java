...
public interface Skip extends Sprint {
    ...
    /**
     * El método se está implementado(tiene body) en la interface por eso sigue siendo
    ...
    /**
     * Los métodos estáticos en interfaces siempre deben tener un body/implemantación por eso sigue siendo
     * una interface funcional (SAM)
